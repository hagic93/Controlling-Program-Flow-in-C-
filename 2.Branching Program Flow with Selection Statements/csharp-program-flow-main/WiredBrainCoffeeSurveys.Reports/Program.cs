...
namespace WiredBrainCoffeeSurveys.Reports
{
    class Program
    {
        ...
        public static void GenerateTasksReport()
        {
            ...
            {
                tasks.Add("Investigate cofee recipes and ingredients.");
            }
            ...
            {
                tasks.Add("Work with employees for impovement ideas.");
            }
            ...
            switch (Q1Results.AreaToImprove)
            {
                ...
                default:
                    tasks.Add("Investingate individual comments for ideas.");
                    break;
            }
        }
    }
